...
document.addEventListener('DOMContentLoaded', () => {
    ...
    images.forEach(img => {
        ...
        img.style.opacity = '1'; // Keep images visible by default
...
// Add counter animation for team members
...
// Add smooth reveal animation for sections (FIXED VERSION)
...
// Add CSS for revealed sections (FIXED VERSION)
...
style.textContent = `
    ...
    .logo-img, .hero-img, .footer-logo-img {
        opacity: 1 !important;
    }
`;
